...
%	\usepackage[abs]{overpic}
	...
	%RWTH Farben, bitte gegenprüfen!
\definecolor{rwthblau}{RGB}{0,84,159}       % 00549F
\definecolor{rwthgruen}{RGB}{87,171,39}     % 57AB27
\definecolor{rwthorange}{RGB}{246,168,0}    % F6A800
\definecolor{rwthbordeaux}{RGB}{161,16,53}  % A11035
\definecolor{rwthgrau}{RGB}{100,101,103}    % 646567

	%RWTH Sekundärabstufungen von Blau (75/50/25/10 %)
\definecolor{rwthblau75}{RGB}{64,127,183}   % 407FB7
\definecolor{rwthblau50}{RGB}{142,186,229}  % 8EBAE5
