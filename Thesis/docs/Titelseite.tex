...
\begin{titlepage}
	...
	\begin{tabularx}{\linewidth}{p{5cm} >{\raggedright\arraybackslash}X}
		...
		\rule[0ex]{0pt}{2.5ex} 	Thema:     & Hier steht der Titel deiner Arbeit      \\
		                                   & bei langen Titeln kannst du den Titel   \\
		                                   & auf diese Art und Weise die Teile umbrechen \\
		                                   & oder du überlässt \LaTeX{} den Umbruch und schreibst einfach fröhlich in einer Zeile bis der Umbruch von alleine kommt. \\ %Ansonsten diese Zeilen löschen.
		%Ansonsten diese Zeilen löschen.
	\end{tabularx}
	\vfill
	\begin{tabularx}{\linewidth}{p{5cm} >{\raggedright\arraybackslash}X} 
		\rule{0pt}{2.5ex} Betreuender Assistent: & Michael Betz, M.~Sc. \\ 
	\end{tabularx} 
...
%		\rule[-6ex]{0pt}{2.5ex} Betreuender Assistent: & Michael Betz, M.~Sc. \\ 
		%1. Prüfer
