...
Im Folgenden wird die akutelle Anlage zum Abisolieren der Hairpins, die als Ausgangspunkt für diese Arbeit genutzt wird, vorgestellt.
...
fest vorgegeben. Zudem ist eine, wie in \cref{fig:AufbauAbisolierZelle} zusehende, Trägertruktur eingebaut, an der
...
Die Laseremitierung ist bei diesem System in den externen gekühlten Serverschrank, in dem auch
...
Bauteile bearbeiten kann. Die optische Strahlungsleistung ist so hoch, dass die Isolierung wie PEEK, PI und PAI
...
der Zelle platziert wurden, der Roboterarm kalibriert und aktiviert wurde. Der letzte Schritt bestand dann die Hairpins
...
jede Hairpin-Geometrien eigene Trays montiert werden, in denen die Hairpins gehalten werden können. Aktuell sind
...
Das Problem dieses Prozesses folgt durch die Pause, die entsteht, wenn der Bedienende die Zelle
...
In der Handhabungstechnik wird in die Teilfunktionen Speichern, Mengen verändern, Bewegen, Sichern
...
Bauteils und Beschaffenheit der schiefen Ebene. Der steilste Winkel beschreibt die Aufstellung im rechten Winkel mit einem Winkel von \qty{90}{\degree}.
