...
\begin{scope}[shift={(10.30,0)}]
  ...
  \draw[{Stealth[length=1.3mm]}-{Stealth[length=1.3mm]}, figKonturHell] (0.75,0.28) -- (1.35,0.28);
\end{scope}
...
\begin{scope}[shift={(0,0)}]
  ...
  \node[text=figText, rotate=90, anchor=south] at (2.62,1.30) {Schwerkraft};
...
\begin{scope}[shift={(10.40,0)}]
  ...
  \end{scope}
  \node[text=figText] at (2.95,0.95) {Takt};
