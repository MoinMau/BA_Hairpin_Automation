...
weiteren Schritt im Prozess, der für das Umbauen benötigt wird.\todo{Muss in Forschungslücke?}
...
anderen Systemen langsame Taktzeit zu nennen. Die größte Störgröße der letzten beiden Systeme ist jedoch die sogenannte Brückenbildung,
...
\begin{tikzpicture}[
  ...
  % Das Werkstueck ist in jeder Abbildung der Arbeit gleich eingefaerbt.
...
robust und in der Industrie gerne eingesetzt, da die Vorbewegung in einer moderaten konstanten Geschwindigkeit passiert. Auch lassen sich
...
verwendet.\PEMfootcite{Altintas.2011} Dabei handelt es sich um eine kleine mechanische Änderung gegenüber der Spindel, bei der statt einer Mutter
...
hier nicht weiter betrachtet, da diese für den Hairpin-Transport ungeeignet sind und in dieser Arbeit nicht weiter betrachtet werden.
%
...
Unterschieden wird in den Greifer, also das Wirk-/Haltesystem an sich, das Antriebssystem für die Bewegung der Fixierung, ein Tragsystem,
...
können jedoch nicht für eine exakte Positionierung verwendet werden und werden im weiteren Verlauf dieser Arbeit aufgegriffen.
...
eine so hohe Individualisierung. Aus diesem Grund ist eine solche Anlage nicht frei auf dem Markt erhältlich.
